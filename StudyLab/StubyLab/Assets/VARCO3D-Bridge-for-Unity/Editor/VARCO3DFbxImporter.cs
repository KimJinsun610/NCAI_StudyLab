        ...
        public static void Import(ImportTask task)
        {
            ...
            try
            {
                ...
                if (importer != null)
                {
                    ...
                    // Configure rig type conservatively. Animation clips alone do
                    // not prove that the imported model has a valid Humanoid avatar.
                    bool hasHumanoidAvatar = false;
                    bool hasAnimationClips = false;
                    ...
                    foreach (var asset in allAssets)
                    {
                        ...
                        {
                            hasHumanoidAvatar = true;
                        }
                        else if (asset is AnimationClip clip && !clip.name.StartsWith("__preview__"))
                        {
                            hasAnimationClips = true;
                        }
                    }

                    if (hasHumanoidAvatar)
                    {
                        importer.importAnimation = true;
                        importer.animationType = ModelImporterAnimationType.Human;
                    }
                    else if (hasAnimationClips)
                    {
                        importer.importAnimation = true;
